...
( 
  ...
  'use strict';
	...
	//   try {
	// 	await Email.send("sachin.mathew@fundfolio.in",
	// 	  "sachinsaji1999@gmail.com",
	// 	  `${message.subject}`,
	// 	  `Name: ${message.name}\n`+ 
    //   `Email: ${message.email}\n`+ 
...
function recaptcha_callback(){
	var registerBtn = document.querySelector('#submit_form');
...
function phonenumber(){
  var phoneno = /^\d{10}$/;
  var input_txt = document.getElementById("#form-numb").value;
  var registerBtn = document.querySelector('#submit_form');
  var temp = '';
  if((input_txt.match(phoneno)) || (input_txt == '')){
	  ...
	  return true;
		...
		document.getElementById('out_message').innerHTML = "Not valid! 10 digit number required.";
...
const sendMessage = event => {
	...
	const message = {
		...
		Number: document.getElementById("#form-numb").value,
		text: document.getElementById("#form-message").value
	};
	smtpJS(message);
}
const smtpJS = async message => {
	...
	document.getElementById('#form-numb').value = '';
